...
$sqldel = "DELETE FROM coupons WHERE id=:delid";
...
$rate=$_POST['price'];
$sql="INSERT INTO coupons(couponcode,rate) VALUES(:coupon,:rate)";
                    ...
                    <div class="panel-body">
                      <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label">Coupon Code
                          </label>
                          <div class="col-sm-3">
              ...
              <table class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo htmlentities($result->couponcode);?>
                    </td>
                    <td>
                      <?php echo htmlentities($result->rate);?>
                    </td>
                    <td>
                      <a href="coupons.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');">
