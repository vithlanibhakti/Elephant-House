...
$itemid=$_GET['edititem'];
  ...
  $sql="UPDATE items SET name=(:name), category=(:category), description=(:description) ,price=(:price), quantity=(:itemqtn), quantitytype=(:itemqtntype), image=(:images) WHERE id=(:id)";
...
?>
                        ...
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <input type="number" name="itemprice" class="form-control" required placeholder="In Rupees" value="<?php echo $resultitem->price; ?>">
                            </div>
