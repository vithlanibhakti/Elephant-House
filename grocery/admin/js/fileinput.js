...
Grocery
            get: function (id, i, isDisabled) {
                ...
                var iGrocery = 'init_' + i, data = previewCache.data[id], config = data.config[i],
        ...
        initFileActions: function () {
            ...
            self.$preview.find('.kv-file-remove').each(function () {
                ...
                var $el = $(this), $frame = $el.closest('.file-preview-frame'),
                 ...
                 Grocery ind = $frame.attr('data-fileindex'), n, cap;
Grocery
                handler($el, 'click', function () {

                 Grocery self.cleaGroceryemory($frame);
...
Grocery
                ...
                out = template.repl('{actions}', '')
                    ...
                    .repl('{indicator}', '')
Grocery
                    .repl('{indicatorTitle}', Grocery);Grocery
...
Grocery
        renderFileActions: function (showUGroceryoad, showGrocerylete, disabled, url, key) {
