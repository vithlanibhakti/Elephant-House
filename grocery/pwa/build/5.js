...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__offers__ = __webpack_require__(352);
...
var OffersPage = /** @class */ (function () {
    function OffersPage(navCtrl, navParams, modalCtrl, alertCtrl, auth, toastController, loadingCtrl) {
        ...
        this.loadingCtrl = loadingCtrl;
        this.chkckt = __WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */].checkCart;
        this.postData = {
            token: "",
            user_id: ""
        };
    ...
    OffersPage.prototype.addToCart = function (itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage) {
        __WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */].storeToCart(itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage, this.itemsuperqty);
        this.showAddCartMsg();
    };
    ...
    OffersPage.prototype.getitemQuantity = function (itemid) {
        for (var _i = 0, _a = __WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */].cartData; _i < _a.length; _i++) {
            var item = _a[_i];
            if (item.itemid == itemid)
                return item.Mquantity;
        }
    ...
    OffersPage.checkCart = function (itemid) {
        var result;
        for (var _i = 0, _a = __WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */].cartData; _i < _a.length; _i++) {
            var val = _a[_i];
            if (val.itemid == itemid) {
    ...
    OffersPage.prototype.changeProductQty = function (itemid, change) {
        var i = 0;
        for (var _i = 0, _a = __WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */].cartData; _i < _a.length; _i++) {
            var item = _a[_i];
            if (item.itemid == itemid) {
    ...
    OffersPage.prototype.openUrl = function (url) {
        window.open(url);
        // let parseUrl:any =  this.sanitizer.bypassSecurityTrustResourceUrl(url)
        // window.open(parseUrl);
    };
    OffersPage.prototype.onclickHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    OffersPage.prototype.openContact = function () {
        this.navCtrl.push('ContactPage');
    };
    OffersPage.prototype.openfeedback = function () {
        this.navCtrl.push('FeedbackPage');
    };
    OffersPage.prototype.openterms = function () {
        this.navCtrl.push('TermsPage');
    };
    OffersPage.prototype.openprivacy = function () {
        this.navCtrl.push('TermsPage');
    };
    OffersPage.prototype.checkLogin = function () {
        if (localStorage.getItem('userData')) {
            return true;
        }
        return false;
    ...
    OffersPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-offers',template:/*ion-inline-start:"/Users/jaydeepkataria/grocery-ionic/src/pages/offers/offers.html"*/'<ion-header>\n  <ion-navbar hideBackButton>\n    <button ion-button menuToggle start>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>{{ \'Offerspage_title\' | translate }}</ion-title>\n\n    <ion-buttons end class="cartbadge">\n      <button ion-button (click)="gotocart()">\n        <ion-icon name="ios-cart"></ion-icon>\n      </button>\n      <ion-badge item-end>{{cartCounterManager()}}</ion-badge>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content no-padding>\n\n  <div class="offersproduct">\n    <ion-card *ngFor="let item of offersFullData;  let i = index;">\n      <img (click)="openProductDetailPage(item.id,item.name,item.image,item.description,item.quantity,item.quantitytype,item.price)" class="p-2"\n        src="{{baseUrlImage}}{{item.image}}">\n      <ion-card-header>\n        <h2 class="text-center">{{item.name}}</h2>\n      </ion-card-header>\n      <ion-card-content>\n        <div class="quantity">{{item.quantity}} {{item.quantitytype}}</div>\n        <div class="price">{{item.price | currency :"$ "}}</div>\n        <div class="qty" *ngIf="chkckt(item.id)">\n          <button round ion-button color="primary" (click)="changeProductQty(item.id,-1)"><b class="cstm">-</b></button>\n          <button round>{{getitemQuantity(item.id)}}</button>\n          <button round ion-button color="primary" (click)="changeProductQty(item.id,1)"><b class="cstm">+</b></button>\n        </div>\n        <button round *ngIf="!chkckt(item.id)" ion-button (click)="addToCart(item.id,item.name,item.quantity,item.quantitytype, item.price, item.image)">Add to Cart</button>\n      </ion-card-content>\n    </ion-card>\n  </div>\n  <div class="footer">\n    <ion-list>\n      <div>\n        <ion-row>\n          <ion-col>\n            <h3>{{\'Explore\' | translate}}</h3>\n            <p (click)="onclickHome()">{{\'Homepage_products\' | translate}}</p>\n\n            <div *ngIf="checkLogin()">\n              <p (click)="openContact()">{{ \'Menupage_contactus\' | translate }}</p>\n            </div>\n            <div *ngIf="checkLogin()">\n              <p (click)="openfeedback()">{{ \'Menupage_feedback\' | translate }}</p>\n            </div>\n            \n          </ion-col>\n          <ion-col>\n            <h3>{{\'Policy_Statement\' | translate}}</h3>\n            <p (click)="openterms()">{{ \'Menupage_terms\' | translate }}</p>\n            <p (click)="openprivacy()" >{{ \'Menupage_privacy\' | translate }}</p>\n          </ion-col>\n          <ion-col>\n            <h3>{{\'Menupage_contactus\' | translate}}</h3>\n            <p>Git Lanka Smart Apps, Sri Lanka</p>\n            <p>+94 7777 022 75</p>\n            <p>wijesinghe@gitl.lk</p>\n            <div >\n              <ion-icon name="logo-facebook" (click)="openUrl(\'https://www.facebook.com/gitlankasmart\')"></ion-icon>\n              <ion-icon name="logo-twitter" (click)="openUrl(\'https://twitter.com/GitLanka\')"></ion-icon>\n              <ion-icon name="logo-instagram" (click)="openUrl(\'https://www.instagram.com/Git_Lanka_Smart_Apps/\')"></ion-icon>\n          </div>\n          </ion-col>\n          <ion-col>\n            <img src="././assets/imgs/android.svg" height="50%" width="50%" alt="Android" (click)="openUrl(\'https://play.google.com/store/apps/details?id=com.app.freshbasket\')"/>\n            <img src="././assets/imgs/iphone.svg" height="50%" width="50%" alt="iOS" (click)="openUrl(\'https://apps.apple.com/app/id1514945632\')"/>\n          </ion-col>\n        </ion-row>\n      </div>\n      \n      <div>\n        <p style="text-align:center;">\n          {{ \'appname\' | translate }} © {{year}}, All rights reserved\n      </p>\n      </div>\n     \n    </ion-list>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/jaydeepkataria/grocery-ionic/src/pages/offers/offers.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */],
