...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_desc__ = __webpack_require__(356);
...
var ProductDescPage = /** @class */ (function () {
    function ProductDescPage(navCtrl, navParams, toastController, auth) {
        this.navCtrl = navCtrl;
    ...
    ProductDescPage.prototype.addtocart = function (itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage) {
    ...
    ProductDescPage.prototype.changeQty = function (change) {
        if (this.itemsuperqty != 0 && this.itemsuperqty + change != 0) {
            this.itemsuperqty += change;
        }
    };
    ProductDescPage.prototype.openUrl = function (url) {
        window.open(url);
        // let parseUrl:any =  this.sanitizer.bypassSecurityTrustResourceUrl(url)
        // window.open(parseUrl);
    };
    ProductDescPage.prototype.onclickHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    ProductDescPage.prototype.openContact = function () {
        this.navCtrl.push('ContactPage');
    };
    ProductDescPage.prototype.openfeedback = function () {
        this.navCtrl.push('FeedbackPage');
    };
    ProductDescPage.prototype.openterms = function () {
        this.navCtrl.push('TermsPage');
    };
    ProductDescPage.prototype.openprivacy = function () {
        this.navCtrl.push('TermsPage');
    };
    ProductDescPage.prototype.checkLogin = function () {
        if (localStorage.getItem('userData')) {
            return true;
        }
        return false;
