...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__products__ = __webpack_require__(357);
...
var ProductsPage = /** @class */ (function () {
    function ProductsPage(navCtrl, navParams, modalCtrl, alertCtrl, auth, toastController, loadingCtrl) {
        ...
        this.itemdatafull = "";
        this.itemFullArray = [];
        this.chkckt = __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].checkCart;
        this.itemsuperqty = 1;
        this.baseUrlImage = auth.getimage();
        if (localStorage.getItem('userData')) {
            var data = JSON.parse(localStorage.getItem('userData'));
    ...
    ProductsPage.prototype.getitemQuantity = function (itemid) {
        for (var _i = 0, _a = __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].cartData; _i < _a.length; _i++) {
            var item = _a[_i];
            if (item.itemid == itemid)
                return item.Mquantity;
        }
    ...
    ProductsPage.checkCart = function (itemid) {
        var result;
        for (var _i = 0, _a = __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].cartData; _i < _a.length; _i++) {
            var val = _a[_i];
            if (val.itemid == itemid) {
    ...
    ProductsPage.prototype.changeProductQty = function (itemid, change) {
        var i = 0;
        for (var _i = 0, _a = __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].cartData; _i < _a.length; _i++) {
            var item = _a[_i];
            if (item.itemid == itemid) {
                ...
                if (qty != 0) {
                    ...
                    console.log(item);
                    __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].cartData.splice(i, 1);
                }
    ...
    ProductsPage.prototype.addToCart = function (itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage) {
    ...
    ProductsPage.prototype.openUrl = function (url) {
        window.open(url);
        // let parseUrl:any =  this.sanitizer.bypassSecurityTrustResourceUrl(url)
        // window.open(parseUrl);
    };
    ProductsPage.prototype.onclickHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    ProductsPage.prototype.openContact = function () {
        this.navCtrl.push('ContactPage');
    };
    ProductsPage.prototype.openfeedback = function () {
        this.navCtrl.push('FeedbackPage');
    };
    ProductsPage.prototype.openterms = function () {
        this.navCtrl.push('TermsPage');
    };
    ProductsPage.prototype.openprivacy = function () {
        this.navCtrl.push('TermsPage');
    };
    ProductsPage.prototype.checkLogin = function () {
        if (localStorage.getItem('userData')) {
            return true;
        }
        return false;
