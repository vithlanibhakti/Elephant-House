...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_search__ = __webpack_require__(361);
...
var ProductSearchPage = /** @class */ (function () {
    ...
    ProductSearchPage.prototype.addToCartProd = function (itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage) {
        if (__WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].checkCart(itemid) != true) {
            __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].storeToCart(itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage, this.itemsuperqty);
    ...
    ProductSearchPage.prototype.buynow = function (itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage) {
        if (__WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].checkCart(itemid) != true) {
            __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].storeToCart(itemid, itemname, itemquantity, itemquantitytype, itemprice, itemimage, this.itemsuperqty);
        }
        this.navCtrl.push('CartPage');
    ...
    ProductSearchPage.prototype.cartCounterManager = function () {
        return __WEBPACK_IMPORTED_MODULE_2__home_home__["a" /* HomePage */].cartData.length;
    };
    ProductSearchPage.prototype.openUrl = function (url) {
        window.open(url);
        // let parseUrl:any =  this.sanitizer.bypassSecurityTrustResourceUrl(url)
        // window.open(parseUrl);
    };
    ProductSearchPage.prototype.onclickHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    ProductSearchPage.prototype.openContact = function () {
        this.navCtrl.push('ContactPage');
    };
    ProductSearchPage.prototype.openfeedback = function () {
        this.navCtrl.push('FeedbackPage');
    };
    ProductSearchPage.prototype.openterms = function () {
        this.navCtrl.push('TermsPage');
    };
    ProductSearchPage.prototype.openprivacy = function () {
        this.navCtrl.push('TermsPage');
    };
    ProductSearchPage.prototype.checkLogin = function () {
        if (localStorage.getItem('userData')) {
            return true;
        }
        return false;
