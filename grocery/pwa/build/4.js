...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__order_confirm__ = __webpack_require__(353);
...
var OrderConfirmPage = /** @class */ (function () {
    ...
    OrderConfirmPage.prototype.openUrl = function (url) {
        window.open(url);
        // let parseUrl:any =  this.sanitizer.bypassSecurityTrustResourceUrl(url)
        // window.open(parseUrl);
    };
    OrderConfirmPage.prototype.onclickHome = function () {
        this.navCtrl.setRoot('HomePage');
    };
    OrderConfirmPage.prototype.openContact = function () {
        this.navCtrl.push('ContactPage');
    };
    OrderConfirmPage.prototype.openfeedback = function () {
        this.navCtrl.push('FeedbackPage');
    };
    OrderConfirmPage.prototype.openterms = function () {
        this.navCtrl.push('TermsPage');
    };
    OrderConfirmPage.prototype.openprivacy = function () {
        this.navCtrl.push('TermsPage');
    };
    OrderConfirmPage.prototype.checkLogin = function () {
        if (localStorage.getItem('userData')) {
            return true;
        }
        return false;
    ...
    OrderConfirmPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-order-confirm',template:/*ion-inline-start:"/Users/jaydeepkataria/grocery-ionic/src/pages/order-confirm/order-confirm.html"*/'<ion-header>\n  <ion-navbar>\n      <button ion-button menuToggle icon-only>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    <ion-title>{{ \'Orderconfirmpage_title\' | translate }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content no-padding>\n  <div class="img-holder"><img class="confirmimg" src="././assets/imgs/order-submitted.png" /></div>\n  <h2 class="textthanks">{{ \'Orderconfirmpage_thankyou\' | translate }}</h2>\n<p class="textorderplaced">{{ \'Orderconfirmpage_yourorder\' | translate }}</p>\n\n<div>\n</div>\n<p class="textorderno">{{ \'Orderconfirmpage_ordernumber\' | translate }}: <span class="orderno">{{orderid}}</span></p>\n<p class="textaddional">T{{ \'Orderconfirmpage_msg\' | translate }}</p>\n<div class="footer">\n  <ion-list>\n    <div>\n      <ion-row>\n        <ion-col>\n          <h3>{{\'Explore\' | translate}}</h3>\n          <p (click)="onclickHome()">{{\'Homepage_products\' | translate}}</p>\n\n          <div *ngIf="checkLogin()">\n            <p (click)="openContact()">{{ \'Menupage_contactus\' | translate }}</p>\n          </div>\n          <div *ngIf="checkLogin()">\n            <p (click)="openfeedback()">{{ \'Menupage_feedback\' | translate }}</p>\n          </div>\n          \n        </ion-col>\n        <ion-col>\n          <h3>{{\'Policy_Statement\' | translate}}</h3>\n          <p (click)="openterms()">{{ \'Menupage_terms\' | translate }}</p>\n          <p (click)="openprivacy()" >{{ \'Menupage_privacy\' | translate }}</p>\n        </ion-col>\n        <ion-col>\n          <h3>{{\'Menupage_contactus\' | translate}}</h3>\n          <p>Git Lanka Smart Apps, Sri Lanka</p>\n          <p>+94 7777 022 75</p>\n          <p>wijesinghe@gitl.lk</p>\n          <div >\n            <ion-icon name="logo-facebook" (click)="openUrl(\'https://www.facebook.com/gitlankasmart\')"></ion-icon>\n            <ion-icon name="logo-twitter" (click)="openUrl(\'https://twitter.com/GitLanka\')"></ion-icon>\n            <ion-icon name="logo-instagram" (click)="openUrl(\'https://www.instagram.com/Git_Lanka_Smart_Apps/\')"></ion-icon>\n        </div>\n        </ion-col>\n        <ion-col>\n          <img src="././assets/imgs/android.svg" height="50%" width="50%" alt="Android" (click)="openUrl(\'https://play.google.com/store/apps/details?id=com.app.freshbasket\')"/>\n          <img src="././assets/imgs/iphone.svg" height="50%" width="50%" alt="iOS" (click)="openUrl(\'https://apps.apple.com/app/id1514945632\')"/>\n        </ion-col>\n      </ion-row>\n    </div>\n    \n    <div>\n      <p style="text-align:center;">\n        {{ \'appname\' | translate }} © {{year}}, All rights reserved\n    </p>\n    </div>\n   \n  </ion-list>\n</div>\n</ion-content>\n'/*ion-inline-end:"/Users/jaydeepkataria/grocery-ionic/src/pages/order-confirm/order-confirm.html"*/,
        }),
